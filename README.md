...
## Description
This is a simple game mimicking the daily lottery. It is reusable and flexible - users can set max number and number of balls to show, as well as title. It utilizes state and setting state.
